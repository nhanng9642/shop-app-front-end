        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            ...
            <div className="mb-1 flex flex-col gap-6 mt-4">
              ...
              />
              {errors.publisher && <ErrorMessage mess={errors.publisher.message} />}
            </div>
            ...
            <div className="mb-1 flex flex-col gap-6 mt-4">
              ...
              />
              {errors.publishedYear && <ErrorMessage mess={errors.publishedYear.message} />}
            </div>
            ...
            <div className="mb-1 flex flex-col gap-6 mt-4">
              ...
              />
              {errors.inventory && <ErrorMessage mess={errors.inventory.message} />}
            </div>
          ...
          <div>
            ...
            <input className="block w-full text-sm text-gray-900 border 
                          ...
                          focus:outline-none" ref={imageInput} name="image"
              onChange={handleChangeImage}
              id="file_input" type="file" />

            {errors.image && <ErrorMessage mess={errors.image.message} />}
            <img src={preview || product?.image || imageDefault} alt="" className="w-80 mt-4" />
          </div>
