import { StatisticsCard, StatisticsChart, TableTopBestSeller } from '../../components'
import {
  CurrencyDollarIcon,
  BookOpenIcon,
  UserIcon,
...
export default function Dashboard() {
  ...
  const [topProductsOptionChart, setTopProductsOptionChart] = useState(columnChart) 
  ...
  useEffect(() => {
    const getRevenue = async () => {
      ...
      const revenueFormat = new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' })
  ...
  useEffect(() => {
    const getTopProducts = async () => {
      ...
      const categories = statistics.map(item => item.productName)
